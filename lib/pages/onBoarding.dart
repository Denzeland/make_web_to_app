...
List<OnBoardingModel> dataUtilits = [
  OnBoardingModel('强大的员工组织架构管理','assets/images/2.png'),
  OnBoardingModel('灵活配置生成审批模板','assets/images/1.png'),
  OnBoardingModel('让管理审批工作流更简便','assets/images/3.png'),
                    ...
                    actions: <Widget>[
                      ElevatedButton(onPressed: (){},
                        child: _reachatend ? InkWell(
                            ...
                            child: Text('开始',style: TextStyle(color: ToolsUtilities.whiteColor,fontSize: 18),)) :InkWell(
                            onTap: (){
                              _updateSeen();
                              Navigator. pushReplacement(context, MaterialPageRoute(
                                  builder: (context) => StarterPage()));
                            },
                            child: Text('跳过',style: TextStyle(color: ToolsUtilities.whiteColor,fontSize: 18),))  ,
